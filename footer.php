    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="/<?php echo ROOT ?>/index.php?logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="/<?php echo ROOT ?>/vendor/datatables/jquery.dataTables.js"></script>
  <script src="/<?php echo ROOT ?>/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="/<?php echo ROOT ?>/js/sb-admin.min.js"></script>
